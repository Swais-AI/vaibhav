  ...
  return (
    <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-4 border-b border-gray-200 sticky top-0 z-20">
      ...
      <div className="flex items-center gap-6 w-full md:w-auto justify-end">
        {/* Notification bell with outside-click-aware dropdown */}
                ...
                {notifications.length === 0 ? (
                  ...
                  notifications.map((n: any, idx: number) => (
                    <Link
                      ...
                      className="p-4 border-b border-gray-50 hover:bg-gray-50 transition-colors flex gap-3 items-start cursor-pointer block"
                    >
        ...
        {/* Profile avatar — initials-based, consistent across all pages */}
